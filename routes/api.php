 ...
 * page perCategory
 */
Route::get('/getchildCategoryById/{id}','PerCategoryController@getchildCategoryById');
Route::get('/getRelatedProductbyCategoryId/{id}','PerCategoryController@getRelatedProductbyCategoryId');
